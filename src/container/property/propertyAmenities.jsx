...
function PropertyAmenities({goToStep}){
    ...
    return (
      <div className="container">
        ...
        <Row>
          <Col>
          <Button onClick={()=>goToStep(1)} className=" float-start" >Prev</Button>
          <Button onClick={()=>goToStep(3)} className=" float-end" >Next</Button>
          </Col>
        </Row>
      </div>
    );
