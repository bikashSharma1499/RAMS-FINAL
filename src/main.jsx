      ...
      <React.Suspense fallback={<Loader />}>
        <Routes>
          <Route path={`${import.meta.env.BASE_URL}`} element={<Auth />}>
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}auth/signup/`}
              element={<Signup />}
            />
            <Route
          ...
          <Route path={`${import.meta.env.BASE_URL}`} element={<App />}>
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}customer/registration/`}
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}agreement/LegalityProcess/`}
              element={<LegalityProcess />}
            />
